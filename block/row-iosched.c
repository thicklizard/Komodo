...
static const int queue_quantum[] = {
	90,	/* ROWQ_PRIO_HIGH_READ */
	90,	/* ROWQ_PRIO_REG_READ */
	25,	/* ROWQ_PRIO_HIGH_SWRITE */
	25,	/* ROWQ_PRIO_REG_SWRITE */
	20,	/* ROWQ_PRIO_REG_WRITE */
	20,	/* ROWQ_PRIO_LOW_READ */
	20	/* ROWQ_PRIO_LOW_SWRITE */
};

/* Default values for idling on read queues */
#define ROW_IDLE_TIME 50	/* 5 msec */
#define ROW_READ_FREQ 65	/* 7 msec */
